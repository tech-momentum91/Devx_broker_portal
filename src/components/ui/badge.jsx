// AlignUI Badge v0.0.0 (JavaScript version)
...
export const badgeVariants = tv({
  ...
  compoundVariants: [
    ...
    { variant: 'filled', color: 'yellow', class: { root: 'bg-away-base text-text-main-900' } },
    ...
    // --- variant = light ---
    {
      variant: 'light',
      color: 'gray',
      class: { root: 'bg-faded-light text-faded-dark' },
    },
    {
      variant: 'light',
      color: 'blue',
      class: { root: 'bg-information-light text-information-dark' },
    },
    {
      variant: 'light',
      color: 'orange',
      class: { root: 'bg-warning-light text-warning-dark' },
    },
    {
      variant: 'light',
      color: 'red',
      class: { root: 'bg-error-light text-error-dark' },
    },
    {
      variant: 'light',
      color: 'green',
      class: { root: 'bg-success-light text-success-darker' },
    },
    {
      variant: 'light',
      color: 'yellow',
      class: { root: 'bg-away-light text-away-dark' },
    },
    {
      variant: 'light',
      color: 'purple',
      class: { root: 'bg-feature-light text-feature-dark' },
    },
    {
      variant: 'light',
      color: 'sky',
      class: { root: 'bg-verified-light text-verified-dark' },
    },
    {
      variant: 'light',
      color: 'pink',
      class: { root: 'bg-highlighted-light text-highlighted-dark' },
    },
    {
      variant: 'light',
      color: 'teal',
      class: { root: 'bg-stable-light text-stable-dark' },
    },
    ...
    // --- variant = lighter ---
    {
      variant: 'lighter',
      color: 'gray',
      class: { root: 'bg-faded-lighter text-faded-base' },
    },
    {
      variant: 'lighter',
      color: 'blue',
      class: { root: 'bg-information-lighter text-information-base' },
    },
    {
      variant: 'lighter',
      color: 'orange',
      class: { root: 'bg-warning-lighter text-warning-base' },
    },
    {
      variant: 'lighter',
      color: 'red',
      class: { root: 'bg-error-lighter text-error-base' },
    },
    {
      variant: 'lighter',
      color: 'green',
      class: { root: 'bg-success-lighter text-success-base' },
    },
    {
      variant: 'lighter',
      color: 'yellow',
      class: { root: 'bg-away-lighter text-away-base' },
    },
    {
      variant: 'lighter',
      color: 'purple',
      class: { root: 'bg-feature-lighter text-feature-base' },
    },
    {
      variant: 'lighter',
      color: 'sky',
      class: { root: 'bg-verified-lighter text-verified-base' },
    },
    {
      variant: 'lighter',
      color: 'pink',
      class: { root: 'bg-highlighted-lighter text-highlighted-base' },
    },
    {
      variant: 'lighter',
      color: 'teal',
      class: { root: 'bg-stable-lighter text-stable-base' },
    },

    // --- stroke variant ---
    { variant: 'stroke', color: 'gray', class: { root: 'text-faded-base ring-stroke-soft-200' } },
    ...
    // --- square ---
    { size: 'small', square: true, class: { root: 'min-w-4 px-1' } },
    { size: 'medium', square: true, class: { root: 'min-w-5 px-1' } },
...
const BadgeRoot = React.forwardRef((props, forwardedRef) => {
  const { asChild, size, variant, color, disabled, square, children, className, ...rest } = props;
  ...
  const sharedProps = { size, variant, color };
...
function BadgeIcon({ className, size, variant, color, as, ...rest }) {
...
function BadgeDot({ size, variant, color, className, ...rest }) {
