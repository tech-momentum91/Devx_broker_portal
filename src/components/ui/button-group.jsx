// AlignUI ButtonGroup v0.0.0 (JSX)
...
export const buttonGroupVariants = tv({
  ...
  variants: {
    size: {
      small: {
        item: ['h-9 gap-4 px-4 text-label-sm', 'first:rounded-l-lg last:rounded-r-lg'],
        icon: '-mx-2 size-5',
      },
      xsmall: {
        item: ['h-8 gap-3.5 px-3.5 text-label-sm', 'first:rounded-l-lg last:rounded-r-lg'],
        icon: '-mx-2 size-5',
      },
      xxsmall: {
        item: ['h-6 gap-3 px-3 text-label-xs', 'first:rounded-l-md last:rounded-r-md'],
        icon: '-mx-2 size-4',
      },
    },
  },
...
function ButtonGroupIcon({ className, size, as: As, ...rest }) {
