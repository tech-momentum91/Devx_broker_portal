// AlignUI StatusBadge v0.0.0 (JS Version)
...
const StatusBadgeRoot = React.forwardRef(
...
function StatusBadgeIcon({ variant, status, className, as }) {
...
function StatusBadgeDot({ variant, status, className, ...rest }) {
